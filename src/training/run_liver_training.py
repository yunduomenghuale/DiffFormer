...
def run_training():
    """
    Main training function for the liver dataset using the DiffFormer model.
    """
    dataset_name = "liver"
    ...
    config = {
        ...
        "model_type": "DiffFormer", # Use the proper name
        "transformer_params": {
            "model_dim": 128,
            "nhead": 4,
    ...
    checkpoints_dir = project_root / "results" / dataset_name / "checkpoints_diffformer"
