...
def plot_for_dataset():
    """
    Generates and saves a detailed comparison plot for the pancreas dataset.
    """
    ...
    try:
        ...
        predictions = {
            ...
            'DiffMLP': np.load(results_dir / 'diffmlp_predicted_proportions.npy'),
        ...
        print(f"Please ensure all deconvolution scripts have been run successfully.")
        return
