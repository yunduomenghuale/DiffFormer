...
def main():
    """
    Main function to run deconvolution for the pbmc3k dataset using the MLP model.
    """
    dataset_name = "pbmc3k"
    MODEL_TYPE = "MLP"
    ...
    if not CHECKPOINT_PATH.exists():
        ...
        print("Please ensure the MLP model has been trained by running 'run_pbmc3k_training_mlp.py'")
        sys.exit(1)
