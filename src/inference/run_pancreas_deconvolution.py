...
def main():
    """
    Main function to run deconvolution for the pancreas dataset.
    """
    dataset_name = "pancreas"
    MODEL_TYPE = "diffformer"
    ...
    checkpoints_dir = results_dir / "checkpoints_diffformer"
    ...
    all_predictions['DiffFormer'] = np.array(our_preds)
    np.save(results_dir / "diffusion_predicted_proportions.npy", all_predictions['DiffFormer'])
